...
static const QRgb MaterialColors[][14] = {
    // Red
    {
        0xFFFFEBEE, // Shade50
        0xFFFFCDD2, // Shade100
...
Material::Shade Material::shade() const
{
    return m_shade;
}

void Material::setShade(Material::Shade shade)
{
    if (m_shade == shade)
        return;
...
QColor Material::color(Color color) const
{
    return Material::color(color, m_shade);
}

QColor Material::color(Color color, Shade shade) const
{
...
QString Material::fontFamily()
{
    ...
    if (family.isEmpty()) {
        int id = QFontDatabase::addApplicationFont(
            ":/qt-project.org/imports/QtCellink/Material/MaterialIcons-Regular.ttf");
