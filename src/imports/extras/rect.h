...
public:
    ...
    Q_INVOKABLE static QRectF adjusted(const QRectF& r, qreal dx1, qreal dy1, qreal dx2, qreal dy2)
    {
        return r.adjusted(dx1, dy1, dx2, dy2);
    }
    ...
    Q_INVOKABLE static QRectF intersected(const QRectF& r1, const QRectF& r2)
    {
    ...
    Q_INVOKABLE static QRectF translated(const QRectF& r, qreal dx, qreal dy)
    {
        return r.translated(dx, dy);
    }
    Q_INVOKABLE static QRectF translated(const QRectF& r, const QPointF& offset)
    {
